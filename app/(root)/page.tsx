...
const Page: NextPage = async () => (
    <div className="container mx-auto max-w-(--breakpoint-lg) my-8">
        ...
        <p className="leading-7 not-first:mt-6">
            Ten Boomgaerde vzw heet u van harte welkom in ons vergadercentrum in
            Lichtervelde.
        </p>
        <p className="leading-7 not-first:mt-6">
        ...
        <ul className="ml-6 mt-2 list-disc [&>li]:mt-2">
            <li>Vergaderingen</li>
            <li>
                Activiteiten van verenigingen (bv. vormingsessies, crea, etc.)
            </li>
            <li>
                Feesten (geboortereceptie, verjaardag, communie, kerst, etc.)
            </li>
        </ul>
        <Image
        ...
        <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
            <li>
                Grote zaal: mogelijkheid om 100 personen aan tafels te plaatsen
            </li>
            <li>
                Kleine zaal: mogelijkheid om 30 personen aan tafels te plaatsen
            </li>
            <li>Keuken met voldoende frigo&apos;s en diepvriezer</li>
            <li>Sanitair (ook voor mindervaliden)</li>
            <li>
                Inkom & vestiaire bij grote zaal (in kleine zaal zijn hangers
                voorzien)
            </li>
        </ul>
        <p className="font-extralight leading-7 not-first:mt-6">
            Het complex is volledig rookvrij (art.2 §1 van het KB van 15/05/90).
        </p>
        <p className="leading-7 not-first:mt-6">
        ...
        <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
            ...
            <li>
                ...
                bijvoorbeeld: glas, papier &amp; karton, organisch afval&hellip;
                dient door de huurder terug meegenomen te worden na gebruik van
                de zaal.
            </li>
        </ul>
        <p className="leading-7 not-first:mt-6">
            Extra glazen kunnen aangevraagd worden bij reservering van de zaal.
            Alle andere benodigdheden dienen zelf meegebracht te worden.
        </p>
        ...
        <p className="leading-7 not-first:mt-6">
            Afrit 9 van de E403. Richting centrum Lichtervelde volgen. Eénmaal
            op de Marktplaats aangekomen, rijdt u rechts van het gemeentehuis de
            Torhoustraat in. Na 20 meter opnieuw naar rechts de Boomgaardstraat
            in. Op 30 meter rechts vindt u zaal Ten Boomgaerde.
        </p>
        <h4 className="mt-8 scroll-m-20 text-xl font-semibold tracking-tight">
            Parking
        </h4>
        ...
        <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
            ...
            <li>
                Dichtstbijzijnde bushalte: Lichtervelde Astridlaan op 5 minuten
                wandelen.
            </li>
        </ul>
    </div>
