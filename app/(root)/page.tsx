...
export default async function Page() {
  return (
    <div className="container mx-auto max-w-screen-lg">
      ...
      <p className="leading-7 [&:not(:first-child)]:mt-6">
        Dit complex bevat een grote- en kleine zaal, die verhuurd worden voor
        allerhande evenementen zoals:
      </p>
      ...
      <Image
        priority
        className="aspect-video rounded object-cover [&:not(:first-child)]:mt-6"
      ...
      <p className="font-extralight leading-7 [&:not(:first-child)]:mt-6">
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        ...
        <li>
          ...
          bijvoorbeeld: glas, papier &amp; karton, organisch afval&hellip; dient
          door de huurder terug meegenomen te worden na gebruik van de zaal.
        </li>
      </ul>
      <p className="leading-7 [&:not(:first-child)]:mt-6">
      ...
      <p className="leading-7 [&:not(:first-child)]:mt-6">
        Het gps-adres Ten Boomgaerde is Boomgaardstraat 4a te 8810 Lichtervelde
      </p>
      <h4 className="mt-8 scroll-m-20 text-xl font-semibold tracking-tight">
        Met de wagen
      </h4>
      <p className="leading-7 [&:not(:first-child)]:mt-6">
        Afrit 9 van de E403. Richting centrum Lichtervelde volgen. Eénmaal op de
        Marktplaats aangekomen, rijdt u rechts van het gemeentehuis de
        Torhoustraat in. Na 20 meter opnieuw naar rechts de Boomgaardstraat in.
        Op 30 meter rechts vindt u zaal Ten Boomgaerde.
      </p>
      <h4 className="mt-8 scroll-m-20 text-xl font-semibold tracking-tight">
        Parking
      </h4>
