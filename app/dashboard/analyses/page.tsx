...
export default async function page() {
    ...
    const queryPreviousMonth = supabase.from("reservations").select(`id, reservation_year, reservation_number, users(id, firstname, lastname), rooms(name), start_hour:bloks!start_hour(start_hour), end_hour:bloks!end_hour(end_hour), start_date, end_date, products(name), access_code, status, gefactureerd, organizations(name), remarks`).gte('start_date', formatDate({date: getDatesOfPreviousMonth().start})).lte('end_date', formatDate({date: getDatesOfPreviousMonth().end})).order('start_date')
