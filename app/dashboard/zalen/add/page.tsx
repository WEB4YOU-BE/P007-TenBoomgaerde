...
export const metadata = {
    title: "Voeg een zaal toe",
    description: 'Voeg een zaal toe aan het gebouw van VZW Ten Boomgaerde Lichtervelde.',
...
export default async function page() {
    return <main className={"mx-auto md:max-w-screen-sm p-2 flex flex-col gap-2"}>
        <h1 className={"text-4xl font-extrabold tracking-tight lg:text-5xl md:flex-grow whitespace-nowrap truncate pb-2"}>Voeg
            een zaal toe</h1>
        <AddRoomForm/>
    </main>
}