...
export default async function page() {
    ...
    return <main className={"flex flex-col gap-2"}>
        <div className={"flex flex-col md:flex-row gap-2 py-4 pl-4"}>
            <h1 className={"text-xl font-semibold text-gray-900 sm:text-2xl scroll-m-20 tracking-tight md:flex-grow"}>Categoriën</h1>
            <Link href={"/dashboard/producten/categorien/add"}
                  className={cn(buttonVariants({variant: "green"}), "mx-2")}>
