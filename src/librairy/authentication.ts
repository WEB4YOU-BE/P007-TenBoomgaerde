    ...
    providers: [
        CredentialsProvider({
            ...
            async authorize(credentials, req) {
                const result = await fetch((process.env.NODE_ENV === "production" ? "https://p007-ten-boomgaerde-git-accounts-system-web4you.vercel.app/" : "http://localhost:3000") + "/api/login", {
                    method: "POST",
