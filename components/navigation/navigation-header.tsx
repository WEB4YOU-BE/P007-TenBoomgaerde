...
export default async function NavigationHeader({children, authNode}: NavigationHeaderProps) {
    return <div
        className={"sm:sticky sm:top-0 sm:z-50 container max-w-screen-xl mx-auto p-2 bg-green-200 rounded-lg m-2"}>
        <div className={"bg-green-200 rounded-lg flex flex-col lg:flex-row overflow-x-auto gap-2"}>
